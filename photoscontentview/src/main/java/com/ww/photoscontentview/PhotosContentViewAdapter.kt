...
abstract class PhotosContentViewAdapter<T> {
    ...
    open fun onItemImageClick(context: Context, imageView: ImageView,
                              index: Int, list: MutableList<T>) {
    }

    open fun onItemImageLongClick(context: Context, imageView: ImageView,
                                  index: Int, list: MutableList<T>): Boolean {
        return false
    }
